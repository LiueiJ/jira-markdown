...
> Hello [[ZHANG_Junsheng_(ETAS-ECMXSF-CN)|Junsheng ZHANG]], The use case with LinTp is enabled, but LinTpRxNSdu and LinTpTxNSdu are not configured. This is a invalid configuration. .Currently, the validator reports an error if no LinTpChannelConfig is configured; But, not check for empty LinTpTxNSdu or LinTpRxNSdu configurations. The validation check will be updated as part of the task below
>
...
> Hi [[ZHANG_Junsheng_(ETAS-ECMXSF-CN)|Junsheng ZHANG]] , sorry for keep you waiting, about your concern:
>
