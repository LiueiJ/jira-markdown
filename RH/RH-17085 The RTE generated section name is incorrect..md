...
updated: "2026-09-11T15:24:29.000+0200"
...
- mentions: [[RH-16520 [VNCNMS][VCTC] RTE Error generated by TimeOut function when E2E SignalGroup is used across cores]]
- mentions: [[RH-17071 [VNCNMS][VCTC]A local variable in Rte_COMCbk is not initialized]]
- mentions: [[RH-16478 [VNCNMS][VCTC] E2E Signalgroup Issue]]
- is mentioned in: [[RH-17140 Logic issues related to E2E signal groups in the RTE]]

## 评论

> [!note]+ 2026-09-11 15:13 · [[Duong_Thi_Ngoc_(ETAS-ECMXPC-Yok1)|Ngoc Duong Thi]]
> [[Ho_Anh_Dang_(MSETA-Hub-CN)|Dang Ho Anh]] there is miss-understanding here. RTA-RTE_12.13.0pr2 does not fix this ticket as [RTE-23401](https://jira.etas-dev.com/browse/RTE-23401)  is still in development. 
>
> I provided RTA-RTE_12.13.0pr2 for RH-17071, RH-16520 and RH-16478
>
> ![[RH-17085-image-2026-09-11-14-13-15-285.png]]

-------

> [!note]+ 2026-09-11 14:57 · [[Ho_Anh_Dang_(MSETA-Hub-CN)|Dang Ho Anh]]
> Hi [[Vamsi_Kiran_Koduri|Vamsi Kiran Koduri]] ,
> I am also verifying this issue on RTA-RTE_12.13.0pr2. Based on my testing, the issue has not been resolved yet.
> For example, the variable shown below is still mapped to the CLEARED section.
> ![[RH-17085-image-2026-09-11-19-53-32-387.png]]
>
> Also, some RTE global variables initialized with 0 are still mapped to the INIT section.
> ![[RH-17085-image-2026-09-11-19-55-53-989.png]]
>
> Could you help check it?
>
> CC: [[Duong_Thi_Ngoc_(ETAS-ECMXPC-Yok1)|Ngoc Duong Thi]] [[Nguyen_Le_Phuong_(MSETA-Hub-CN)|Phuong Nguyen Le]] [[JI_Jiaqi_(ETAS-ECMXSF-CN)|Jiaqi JI]] 
