...
updated: "2026-09-10T07:31:35.000+0000"
...
> [!note]+ 2026-09-10 07:18 · [[Nguyen_Quoc_Su_(MSETA-Hub-CN)|Nguyen Quoc Su (MS/ETA-Hub-CN)]]
> [[CHEN_Yi_(ETAS-ECMXSF-CN)|CHEN Yi (ETAS-ECM/XSF-CN)]], [[WU_Yanan_(ETASCCN1)|WU Yanan (ETAS/CCN1)]],
> Please be noted the Inputs/ precondition stars - {color:#de350b}critical Items1,3: NOT provided yet{color}
> Which mean the target delivery T+4W: forecast shift to {color:#de350b}8-Oct{color} (09.30/VmAX expected). This will impact our capacity planning, will impacts delivery commitment both our VMAX customer and others customer (BAIC &RBCD). It will be Increasing resource balancing pressure across projects delivery. 
> {color:#4c9aff}Please ask VMAX to delivery inputs on time, the expected timeline is too aggressive!{color} It's high delivery risk to respond Ford's spec and new F29x target.
>
> {color:#de350b}Is VMAX ready to send the inputs/ precondition start to ETAS?{color}
>
> Cc: [[HE_Jiankang_(ETAS-ECMXSF-CN)|HE Jiankang (ETAS-ECM/XSF-CN)]] 
> | Inputs/ precondition - delivery planned by VMAX |
> | --- |
> | # Board & debugger delivery——{color:#ff0000}10-Sep{color} |
>  # DSP/DET validation tools——{color:#ff0000}11-Sep{color}
>  # MCAL delivery——{color:#ff0000}4-Sep{color}|
>
> ![[ARC-17359-image-2026-09-10-14-14-38-358.png]]
