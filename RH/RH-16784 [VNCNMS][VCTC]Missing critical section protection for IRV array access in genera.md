...
> Hi [[Nguyen_Le_Phuong_(MSETA-Hub-CN)|Phuong Nguyen Le]] , Yes. As mentioned before this is an issue and will be fixed in upcoming rte version. For now we suggest customer to map OIE event to task which result in expected code with data protection. 
