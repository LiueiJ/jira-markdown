...
6. ConfGen failed without any problems. Screenshot not available. Info like: Internal Error:Sd. Reopen RTA-CAR can fix this issue. Split to [https://rtahotline.etas.com/jira/browse/RH-17181](https://rtahotline.etas.com/jira/browse/RH-17023)
...
- mentions: [[RH-17181 [VCTC] RTA-CAR 12.11 Migration RTA-CAR Toolchain Issues - ConfGen]]
...
>
> If there are any outstanding points from this specific ticket you would like answering, please either outline them here if it relates to all the split issues or alternatively add the outstanding points to the relevant individual split issues. Thanks!
>
> Best Regards,
> James
