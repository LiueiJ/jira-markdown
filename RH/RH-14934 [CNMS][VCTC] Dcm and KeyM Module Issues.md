...
# RH-14934 [CNMS][VCTC] Dcm and KeyM Module Issues

> [!jira] Closed · High · [[Junsheng_ZHANG|Junsheng ZHANG]] · 更新于 2026-04-22T11:37:33.000+0200
> [在 Jira 中打开](https://rtahotline.etas.com/jira/browse/RH-14934)
...
> Hi [[Junsheng_ZHANG|Junsheng ZHANG]] , as I mentioned in the previous response, if the customer does **not use** StbM to obtain the time, they can retrieve it via an external CallOut function ({*}KeyM_CertificateGetCurrentTimeCalloutFunc{*}).
>
...
> [!note]+ 2026-03-23 03:03 · [[Junsheng_ZHANG|Junsheng ZHANG]]
...
> [!note]+ 2026-01-28 13:55 · [[Junsheng_ZHANG|Junsheng ZHANG]]
